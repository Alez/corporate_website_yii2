...
class Odnoklassniki extends OAuth2 {
    ...
    public function getUserAttributes()
    {
        ...
        if (isset($attributes['location']['city'])) {
            $newAttributes['city'] = $attributes['location']['city'];
        }
        if (isset($attributes['location']['countryName'])) {
            $newAttributes['country'] = $attributes['location']['countryName'];
        }
        if (isset($attributes['pic_2'])) {
            $newAttributes['photo'] = preg_replace('/photoType=\K\d/', '0', $attributes['pic_2']);
        }
        if (isset($attributes['birthday'])) {
            $newAttributes['birth'] = $attributes['birthday'];
        }
